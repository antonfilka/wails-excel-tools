  ...
  return (
    <div className="w-full h-full flex flex-col gap-3">
      ...
      <div className="w-full mt-5 text-sm">
        Оба файла должны быть в формате XLSX. Оба файла должны быть
        отформатированы одинаковым образом. Первая колонка - ФИО. Последующие
        колонки - данные по датам, где каждая дата занимает отдельную колонку
      </div>
    </div>
  );
};
